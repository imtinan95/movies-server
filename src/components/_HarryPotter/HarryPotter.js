...
const harryPotter = [
  ...
  },
  {
    ...
    accessor:
      'Harry.Potter.and.the.Chamber.of.Secrets.2002.1080p.BrRip.x264.YIFY',
  },
  {
    title: 'Harry Potter and the Prisoner of Azkaban (2004)',
    accessor:
      'Harry.Potter.and.the.Prisoner.of.Azkaban.2004.1080p.BrRip.x264.YIFY',
  },
  {
  ...
  },
  {
    ...
    accessor:
      'Harry.Potter.and.the.Order.of.the.Phoenix.2007.1080p.BrRip.x264.YIFY',
  },
  {
  ...
  },
  {
    ...
    accessor:
      'Harry.Potter.and.the.Deathly.Hallows.Part.1.2010.1080p.BrRip.x264.YIFY',
  },
  {
    title: 'Harry Potter And The Deathly Hallows Part 2 (2011)',
    accessor:
      'Harry.Potter.And.The.Deathly.Hallows.Part.2.2011.1080p.BrRip.264.YIFY',
  },
]
  ...
  return (
    <div className="HarryPotterBody">
      ...
      <h1 className="StyleTextAlignCenter">
        T'is page is dedicated for Harry Potter Movies, everyone is 1080p
      </h1>
