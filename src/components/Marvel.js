...
const spiderman = [
    ...
    },
    {
        ...
        accessor: 'Spider-Man.Into.The.Spider-Verse.2018.1080p.BluRay.x264-[YTS.AM]',
    },
];
const captainmarvel = [
    {
...
export function Marvel() {
    ...
    return (
        <div className="MarvelBody">
            ...
            <h1 className="StyleTextAlignCenter">Tis page is dedicated for Marvel Movies</h1>
            ...
            <div className="Container-Content">
                ...
                <div className="Movies">
                    {ironman
                        ...
                        .map(function (movie) {
                            return <MarvelMovies title={movie.title} accessor={movie.accessor} />;
                        })}
                </div>
            </div>
            {/* THor Series */}
